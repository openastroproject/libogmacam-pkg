...
tar zxf ../libogmacam-$version.tar.gz
cd $srcdir
...
dh_make $YFLAG -l -f ../../libogmacam-$version.tar.gz
...
cp ../debfiles/libogmacam.dirs $debdir
cp ../debfiles/libogmacam.install $debdir
cp ../debfiles/libogmacam.symbols $debdir
cp ../debfiles/libogmacam.triggers $debdir
cp ../debfiles/libogmacam-dev.dirs $debdir
cp ../debfiles/libogmacam-dev.install $debdir
...
rm -f $debdir/libogmacam-docs.docs
rm $debdir/libogmacam1.*
rm $debdir/*.[Ee][Xx]
...
echo "Now run:"
echo
echo "    lintian -i -I --show-overrides libogmacam_$version-1_amd64.changes"
